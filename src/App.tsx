      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6">
        ...
        {isAdminPage ? (
          ...
          <>
            ...
            <header className="mb-8 p-6 rounded-3xl border border-white/10 bg-[#0b1120]/60 backdrop-blur-xl shadow-2xl flex flex-col md:flex-row md:items-center md:justify-between gap-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-400 mt-1 font-medium">
                    تصفح آلاف القنوات والأفلام والمسلسلات مع البث المباشر الفوري
                  </p>
                </div>
              </div>
            ...
            {matches.length > 0 && (
              <div className="mb-8 p-6 rounded-3xl border border-white/10 bg-[#0b1120]/60 backdrop-blur-xl shadow-2xl text-right animate-fade-in" dir="rtl">
                <div className="flex items-center justify-between mb-5">
                  <div className="flex items-center gap-2">
                    ...
                    <h2 className="text-lg font-black bg-clip-text text-transparent bg-gradient-to-r from-white via-gray-200 to-gray-400">
                      مباريات اليوم والـبـث الـمـبـاشـر
                    </h2>
                  </div>
                  <span className="text-xs text-cyan-400 font-extrabold bg-cyan-500/10 px-3 py-1 rounded-full border border-cyan-500/20">
                    انقر للتشغيل الفوري 📺
                  </span>
                </div>
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex justify-between items-center mb-4">
                          <span className={`px-2.5 py-1 rounded-lg text-[10px] font-black flex items-center gap-1 shadow-sm ${
                            isLive 
                        ...
                        <div className="flex items-center justify-between gap-2 my-2">
                          ...
                          <div className="flex-1 flex flex-col items-center text-center gap-2">
                            {m.team1Logo ? (
                              <img
                                src={m.team1Logo}
                                alt={m.team1}
                                className="w-12 h-12 rounded-full object-cover border border-white/10 group-hover:scale-105 transition-transform duration-300 shadow-md"
                                referrerPolicy="no-referrer"
                              />
                            ) : (
                              <div className="w-12 h-12 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-lg group-hover:scale-105 transition-transform duration-300">⚽</div>
                            )}
                            <span className="font-extrabold text-xs text-white truncate max-w-full group-hover:text-cyan-300 transition-colors">{m.team1}</span>
                          </div>

                          {/* Versus badge */}
                          <div className="flex-shrink-0 flex flex-col items-center">
                            <span className="px-3 py-1.5 rounded-xl bg-gradient-to-r from-cyan-500/10 to-indigo-500/10 border border-white/10 font-black text-[10px] text-cyan-400 shadow-md">
                              VS
                            </span>
                          </div>
                          ...
                          <div className="flex-1 flex flex-col items-center text-center gap-2">
                            ...
                            <span className="font-extrabold text-xs text-white truncate max-w-full group-hover:text-cyan-300 transition-colors">{m.team2}</span>
                          </div>
                        </div>

                        {/* Bottom channel bar */}
                        <div className="mt-4 pt-3.5 border-t border-white/5 flex items-center justify-between text-[11px] font-bold text-gray-400">
                          <div className="flex items-center gap-1 text-cyan-400 font-extrabold">
                            <Tv className="w-3.5 h-3.5" />
                            <span>{m.channelName}</span>
                          </div>
                          <span className="text-[10px] text-gray-500 group-hover:text-white transition-colors flex items-center gap-1">
                            <span>شاهد البث</span>
                            <ChevronLeft className="w-3.5 h-3.5" />
                          </span>
                        </div>
            ...
            <div className="mb-6 flex flex-col lg:flex-row gap-4 items-stretch lg:items-center justify-between">
              ...
              {/* Custom styled tabs */}
              <div className="flex p-1.5 bg-[#0b1120]/80 border border-white/5 rounded-2xl md:max-w-md w-full shadow-lg">
                <button
                  ...
                  {streams.map((stream) => {
                    ...
                    return (
                      <div
                        ...
                        className="group relative flex flex-col h-full bg-[#0b1120]/70 border border-white/10 hover:border-cyan-500/50 rounded-2xl overflow-hidden cursor-pointer transition-all duration-300 hover:shadow-[0_10px_30px_rgba(6,182,212,0.15)] hover:-translate-y-1"
                      >
                        {/* Media container */}
                        <div className="relative aspect-[3/4] bg-[#070b14] overflow-hidden">
                          ...
                          <div 
                            className="absolute inset-0 flex flex-col items-center justify-center p-4 text-center bg-gradient-to-b from-[#111827] to-[#070b14]"
                            style={{ display: imageSrc ? 'none' : 'flex' }}
                          >
                            {activeTab === 'live' ? (
                              <Tv className="w-10 h-10 text-cyan-500/40 mb-2 group-hover:scale-110 transition-transform" />
                            ) : activeTab === 'vod' ? (
                              <Film className="w-10 h-10 text-fuchsia-500/40 mb-2 group-hover:scale-110 transition-transform" />
                            ) : (
                              <Clapperboard className="w-10 h-10 text-indigo-500/40 mb-2 group-hover:scale-110 transition-transform" />
                            )}
                            <span className="text-xs text-gray-500 font-semibold line-clamp-2 px-1">
                              {stream.name}
                            </span>
                          </div>
                          ...
                          <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                            <div className="w-12 h-12 rounded-full bg-cyan-400 text-black flex items-center justify-center shadow-lg transform translate-y-4 group-hover:translate-y-0 transition-all duration-300">
                          ...
                          {displayRating && (
                            <div className="absolute top-2 right-2 px-2 py-1 rounded-lg bg-black/75 backdrop-blur-md text-[10px] font-black text-amber-400 flex items-center gap-1 shadow-md">
                              ⭐ {displayRating.toFixed(1)}
                            </div>
                          )}

                          {/* Type badge on bottom right */}
                          <div className="absolute bottom-2 right-2 px-2.5 py-0.5 rounded-md bg-[#030614]/80 backdrop-blur-md border border-white/10 text-[9px] font-bold text-gray-300">
                        ...
                        <div className="p-3.5 flex flex-col justify-between flex-grow">
                          <h3 className="text-xs font-bold text-gray-200 group-hover:text-cyan-400 transition-colors line-clamp-2 leading-relaxed">
                            {stream.name}
                          </h3>
                        </div>
                      </div>
